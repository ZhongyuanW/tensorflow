# -*- coding: utf-8 -*-
"""
Created on Thu Dec 14 16:38:39 2017
...
def inception_v3_base(inputs,scope=None):
    ...
    with tf.variable_scope(scope,'InceptionV3',[inputs]):
        with slim.arg_scope([slim.conv2d,slim.max_pool2d,slim.avg_pool2d],
            ...
            print_activations(net)
            net = slim.conv2d(net,192,[3,3],scope='Conv2d_4d_3x3')
            print_activations(net)
        ...
        with slim.arg_scope([slim.conv2d,slim.max_pool2d,slim.avg_pool2d],
            ...
            #####         第一个Inception模块组                 ####
            #第1个 Inception Module
            with tf.variable_scope('Mixed_5b'):
                with tf.variable_scope('Branch_0'):
                    branch_0 = slim.conv2d(net,64,[1,1],scope='Conv2d_0a_1x1')
                    print_activations(branch_0)
                with tf.variable_scope('Branch_1'):
                    branch_1 = slim.conv2d(net,48,[1,1],scope='Conv2d_0a_1x1')
                    print_activations(branch_1)
                    branch_1 = slim.conv2d(branch_1,64,[5,5],scope='Conv2d_0b_5x5')
                    print_activations(branch_1)
                with tf.variable_scope('Branch_2'):
                    branch_2 = slim.conv2d(net,64,[1,1],scope='Conv2d_0a_1x1')
                    print_activations(branch_2)
